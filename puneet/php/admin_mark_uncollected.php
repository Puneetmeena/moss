      ...
      if ($data && $mode && $date) {
        ...
        if ($mode == "no filter") {
          ...
          foreach ($data_decode->info as $key) {
            ...
            $q = "UPDATE manage_queue SET collection_status = 'Not Collected' where group_id = '$group_id'";
                ...
                if ($q6_run = $db->query($q6)) {
                  ...
                  if ($q6_run->num_rows) {
                    ...
                    if ($q6_fetch = $q6_run->fetch_assoc()) {
                      ...
                      array_push($arr, "Order was marked Not Collected on $date by Admin-Email-ID: $admin_email and Admin-ID: $admin_id");
