  ...
  if ($admin_id) {
    ...
    if (isset($_POST['mode'])) {
      ...
      if ($mode == "no filter") {
        ...
        $q1 = "SELECT * from shipping_queue LIMIT 10";
      ...
      elseif ($mode == "filtered") {
        ...
        if (isset($_SESSION['filter_order_id'])) {
          ...
          if ($filter_order_id) {
            ...
            $q1 = "SELECT * from shipping_queue where order_id = '$filter_order_id' OR group_id = '$filter_order_id'";
        ...
        elseif (isset($_SESSION['filter_phone_number'])) {
          ...
          if (isset($_SESSION['filter_rpp'])) {
            ...
            if ($filter_rpp) {
              ...
              $q = "SELECT * from shipping_queue where order_phone = '$filter_phone_number' LIMIT $filter_rpp";
            ...
            $q = "SELECT * from shipping_queue where order_phone = '$filter_phone_number'";
        ...
        elseif (isset($_SESSION['filter_rpp'])) {
          ...
          if ($filter_rpp) {
            ...
            $q1 = "SELECT * from shipping_queue LIMIT $filter_rpp";
