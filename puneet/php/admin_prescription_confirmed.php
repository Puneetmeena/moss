  ...
  if ($admin_id) {
    ...
    if (isset($_POST['group_id']) && isset($_POST['date'])) {
      ...
      if ($date && $group_id) {
        ...
        $q1 = "UPDATE cc_queue SET prescription_confirmed  = '1' where group_id = '$group_id'";
                ...
                if ($q6_run = $db->query($q6)) {
                  ...
                  if ($q6_run->num_rows) {
                    ...
                    if ($q6_fetch = $q6_run->fetch_assoc()) {
                      ...
                      array_push($arr, "Prescription was confirmed on $date by Admin-Email-ID: $admin_email and Admin-ID: $admin_id");
